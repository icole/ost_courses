<?php
  ...
  if (!($customer_name && $customer_email && $_GET['whoami'] 
     ...
     $url = "http://".$_SERVER['HTTP_HOST']."/ost_courses/introphp/lesson13/contact_form.php?".$query_string."&error=1";;
  ...
  mail_message($_GET, "./email_template.txt", $deadline_str, $customer_name, $customer_email);
